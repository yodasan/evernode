...
var ttypes = Types_ttypes = module.exports = require('./Types_types');
...
AdImpressions = module.exports.AdImpressions = function(args) {
  this.adId = null;
...
AdParameters = module.exports.AdParameters = function(args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem178 = null;
          elem178 = new ttypes.AdImpressions();
          elem178.read(input);
          this.impressions.push(elem178);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        var _ktype180 = 0;
        var _vtype181 = 0;
        _rtmp3183 = input.readMapBegin();
        _ktype180 = _rtmp3183.ktype;
        _vtype181 = _rtmp3183.vtype;
        ...
        for (var _i184 = 0; _i184 < _size179; ++_i184)
        {
          ...
          this.clientProperties[key185] = val186;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
AdParameters.prototype.write = function(output) {
  ...
  if (this.impressions !== null && this.impressions !== undefined) {
    ...
    for (var iter187 in this.impressions)
    {
      if (this.impressions.hasOwnProperty(iter187))
      {
        iter187 = this.impressions[iter187];
  ...
  if (this.clientProperties !== null && this.clientProperties !== undefined) {
    ...
    for (var kiter188 in this.clientProperties)
    {
      if (this.clientProperties.hasOwnProperty(kiter188))
      {
        var viter189 = this.clientProperties[kiter188];
