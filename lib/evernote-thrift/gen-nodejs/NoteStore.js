  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem212 = null;
          elem212 = new Types_ttypes.Notebook();
          elem212.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem236 = null;
          elem236 = new Types_ttypes.SavedSearch();
          elem236.read(input);
...
NoteStore_expungeNotes_args.prototype.write = function(output) {
  ...
  if (this.noteGuids !== null && this.noteGuids !== undefined) {
    ...
    for (var iter253 in this.noteGuids)
    {
      if (this.noteGuids.hasOwnProperty(iter253))
      {
        iter253 = this.noteGuids[iter253];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem260 = null;
          elem260 = new ttypes.NoteVersionId();
          elem260.read(input);
...
NoteStore_getAccountSize_args = function(args) {
  this.authenticationToken = null;
  if (args) {
    if (args.authenticationToken !== undefined) {
      this.authenticationToken = args.authenticationToken;
...
NoteStore_getAccountSize_result = function(args) {
  this.success = null;
  this.userException = null;
  this.systemException = null;
  if (args instanceof Errors_ttypes.EDAMUserException) {
...
NoteStore_sendMessageToSharedNotebookMembers_args.prototype.write = function(output) {
  ...
  if (this.recipients !== null && this.recipients !== undefined) {
    ...
    for (var iter277 in this.recipients)
    {
      if (this.recipients.hasOwnProperty(iter277))
      {
        iter277 = this.recipients[iter277];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem284 = null;
          elem284 = new Types_ttypes.SharedNotebook();
          elem284.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem292 = null;
          elem292 = input.readI64();
          this.sharedNotebookIds.push(elem292);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
NoteStore_expungeSharedNotebooks_args.prototype.write = function(output) {
  ...
  if (this.sharedNotebookIds !== null && this.sharedNotebookIds !== undefined) {
    ...
    for (var iter293 in this.sharedNotebookIds)
    {
      if (this.sharedNotebookIds.hasOwnProperty(iter293))
      {
        iter293 = this.sharedNotebookIds[iter293];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem300 = null;
          elem300 = new Types_ttypes.LinkedNotebook();
          elem300.read(input);
...
NoteStoreProcessor.prototype.process_getAccountSize = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  this._handler.getAccountSize(args.authenticationToken, function (err, result) {
    var result = new NoteStore_getAccountSize_result((err != null ? err : {success: result}));
...
NoteStoreProcessor.prototype.process_getAds = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  this._handler.getAds(args.authenticationToken, args.adParameters, function (err, result) {
    var result = new NoteStore_getAds_result((err != null ? err : {success: result}));
...
NoteStoreProcessor.prototype.process_getRandomAd = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  this._handler.getRandomAd(args.authenticationToken, args.adParameters, function (err, result) {
    var result = new NoteStore_getRandomAd_result((err != null ? err : {success: result}));
